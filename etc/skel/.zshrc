...
alias dir="command ls -lSrah --color"
...
if grep -q "Arch" "/etc/issue"
then
    alias Syu='yaourt -Sayu --devel --noconfirm'
    alias Su='yaourt -Sau --devel --noconfirm'
elif grep -q "Debian" "/etc/issue"
then
    alias Syu='apt update && apt upgrade'
    alias Su='apt upgrade'
fi
## END OF FILE #################################################################
